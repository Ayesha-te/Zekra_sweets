...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with Zekra Sweets. Questions, orders, or a warm hello — we'd love to hear from you." },
    ...
    <SiteLayout>
      <section className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="glass rounded-[2.5rem] p-8 md:p-14 text-center" data-reveal>
          ...
          <h1 className="mt-3 font-display text-5xl sm:text-6xl">Say <span className="text-gradient-gold">hello.</span></h1>
          <p className="mx-auto mt-4 max-w-xl text-foreground/75">
            Feel free to contact us with any questions or concerns. Use the form
            below or email us directly — we look forward to hearing from you.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.4fr]">
          <div className="glass rounded-3xl p-8" data-reveal>
            ...
            <div className="mt-8 rounded-2xl bg-gradient-warm p-5">
              ...
              <div className="mt-2 text-sm text-foreground/80">Saturday — Thursday · 8 AM to 10 PM</div>
              <div className="text-sm text-foreground/80">Friday · 2 PM to 10 PM</div>
            </div>
          </div>

          <form onSubmit={(e) => { e.preventDefault(); alert("Thanks! We'll be in touch."); }} className="glass grid gap-4 rounded-3xl p-8 sm:grid-cols-2" data-reveal style={{ transitionDelay: "80ms" }}>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea required rows={6} placeholder="Share your thoughts or ideas about Zekra Sweets…" className="mt-2 w-full rounded-2xl border border-border bg-cream/60 px-4 py-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" />
            </div>
