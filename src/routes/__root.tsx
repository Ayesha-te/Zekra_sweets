  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-HHN1SZZVXK"
        />
      ...
      <body>
        ...
        <script
          ...
          data-id="wdg_rUfeKg5Bpwfom3kVBtNxtJmh"
          defer
        />
...
function RootComponent() {
  ...
  useEffect(() => {
    const moveChatbotLeft = () => {
      ...
      if (
        !host?.shadowRoot ||
        host.shadowRoot.querySelector("#zekra-chatbot-left-position")
      ) {
