...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-HHN1SZZVXK"></script>
        <script
...
gtag('config', 'G-HHN1SZZVXK');`,
      ...
      <body>
        {children}
        <Scripts />
        <script src="https://cdn.zanderio.ai/widget/loader.js" data-id="wdg_rUfeKg5Bpwfom3kVBtNxtJmh" defer></script>
        <!-- Meta Pixel Code -->
<script>
...
fbq('init', '1607018814407757');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1607018814407757&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
      </body>
    </html>
